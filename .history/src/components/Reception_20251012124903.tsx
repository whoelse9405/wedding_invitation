...
const Reception: React.FC = () => {
  ...
  const venueName = '투아워게스트 가든';
  const venueAddress = '서울 종로구 돈화문로11가길 47';
  const venueDate = '9월 20일 토요일 오후 5시 - 7시';
    ...
    <section ref={elementRef} className={`reception-section section ${isVisible ? 'animate' : ''}`}>
      ...
      <div className="reception-content">
        ...
        <div className="reception-info-card">
          <h3 className="reception-subtitle">신랑 이민호 · 신부 배하윤 피로연</h3>
          ...
          <button className="reception-confirm-btn" onClick={handleConfirm}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
