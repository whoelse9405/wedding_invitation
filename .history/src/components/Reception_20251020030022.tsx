        ...
        <div className="transportation-info-new">
          <div className="transport-item">
            <div className="transport-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                {/* 자동차 상단 지붕 (윈드실드) */}
                <path d="M 6 9 L 8 5 C 8.5 4 9.5 3.5 10.5 3.5 L 13.5 3.5 C 14.5 3.5 15.5 4 16 5 L 18 9" strokeLinejoin="round" strokeLinecap="round"/>
                {/* 자동차 본체 외곽선 */}
                <path d="M 3 9 C 3 9 3.5 8.5 4.5 8.5 L 5.5 8.5 M 18.5 8.5 L 19.5 8.5 C 20.5 8.5 21 9 21 9" strokeLinejoin="round" strokeLinecap="round"/>
                {/* 좌측 사이드미러 */}
                <path d="M 3.5 9 C 2.5 9 2 9.5 2 10.5 C 2 11.5 2.5 12 3.5 12" strokeLinejoin="round" strokeLinecap="round"/>
                {/* 우측 사이드미러 */}
                <path d="M 20.5 9 C 21.5 9 22 9.5 22 10.5 C 22 11.5 21.5 12 20.5 12" strokeLinejoin="round" strokeLinecap="round"/>
                {/* 자동차 하단 본체 */}
                <path d="M 3.5 12 L 3.5 17.5 C 3.5 18 4 18.5 4.5 18.5 L 5.5 18.5 M 18.5 18.5 L 19.5 18.5 C 20 18.5 20.5 18 20.5 17.5 L 20.5 12" strokeLinejoin="round" strokeLinecap="round"/>
                {/* 좌측 헤드라이트 */}
                <ellipse cx="7.5" cy="12.5" rx="2" ry="1.2" strokeWidth="2.2"/>
                {/* 우측 헤드라이트 */}
                <ellipse cx="16.5" cy="12.5" rx="2" ry="1.2" strokeWidth="2.2"/>
                {/* 하단 범퍼 */}
                <line x1="6.5" y1="16.5" x2="17.5" y2="16.5" strokeWidth="2.5" strokeLinecap="round"/>
              </svg>
