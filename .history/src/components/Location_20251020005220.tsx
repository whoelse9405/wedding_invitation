    ...
    const loadKakaoMap = () => {
      ...
      window.kakao.maps.load(() => {
        ...
        const infowindow = new window.kakao.maps.InfoWindow({
          content: `<div style="position:relative;padding:15px 40px 15px 20px;font-size:16px;font-weight:600;color:#ffffff;background:white;border-radius:18px;box-shadow:0 4px 16px rgba(0,0,0,0.2);min-width:180px;text-align:center;">
                      ${venueName}
