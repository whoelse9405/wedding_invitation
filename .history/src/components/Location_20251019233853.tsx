      ...
      <div className="location-content">
        ...
        <div className="transportation-info-new">
          ...
          <div className="transport-item">
            ...
            <div className="transport-details">
              <p className="transport-detail-text">아크로힐스논현 하차(구 경복아파트) 23-138. 23-273</p>
              <p className="transport-detail-text">지선버스: 3412, 6411</p>
              <p className="transport-detail-text transport-spacing">라움아트센터, 시티프라움더강남 하차</p>
              <p className="transport-detail-text">간선버스: 141, 242</p>
          ...
          <div className="transport-item">
            ...
            <div className="transport-details">
              <p className="transport-detail-text">2호선 삼성역 6번 출구 도보 5분</p>
              <p className="transport-detail-text">분당선 선릉역 10번 출구 도보 7분</p>
            </div>
          </div>
        </div>
      </div>
