...
const Contact: React.FC = () => {
  ...
  const contacts = {
    groom: {
      ...
      motherName: '신소라',
      persons: [
        { name: '최준호', phone: '010-4039-8579', relation: '' },
        { name: '최대진', phone: '010-3892-8579', relation: '아버지' },
        { name: '신소라', phone: '010-3188-5323', relation: '어머니' },
      ] as ContactPerson[],
    },
    bride: {
      name: '수연',
      ...
      motherName: '고지원',
      persons: [
        { name: '김수연', phone: '010-8891-6225', relation: '' },
        { name: '이정호', phone: '010-2696-6224', relation: '아버지' },
        { name: '고지원', phone: '010-2696-7779', relation: '어머니' },
      ] as ContactPerson[],
    },
  };
  ...
  return (
    <>
      <section ref={elementRef} className={`contact-section-new section ${isVisible ? 'animate' : ''}`}>
        <div className="contact-parents-display">
          <div className="parents-line">
            ...
            <span className="parent-name flower">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <circle cx="12" cy="12" r="3"></circle>
                <path d="M12 2v4m0 12v4M2 12h4m12 0h4m-3.5-7.5l2.8-2.8m-14.6 0L4.9 4.5m14.6 14.6l-2.8-2.8m-9.9 9.9l-2.8-2.8"></path>
              </svg>
              {contacts.groom.motherName}
            </span>
            <span className="relation-text">의</span>
            <span className="child-name">
              아들 {contacts.groom.name}
