        ...
        <div className="transportation-info-new">
          <div className="transport-item">
            <div className="transport-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                {/* 상단 지붕/윈드실드 - 채워진 영역 */}
                <path d="M 4 7 L 6 3 C 6.5 2 7.5 1.5 9 1.5 L 15 1.5 C 16.5 1.5 17.5 2 18 3 L 20 7 L 22 7 L 22 9 L 2 9 L 2 7 Z" fill="currentColor" stroke="none"/>
                
                {/* 자동차 본체 메인 */}
                <path d="M 1.5 9 L 1.5 13 C 1.5 14 2 15 3 15.5 L 4 16 L 4 17.5 C 4 18.5 4.5 19 5.5 19 L 7 19 C 7.5 19 8 18.5 8 18 L 8 16.5 M 16 16.5 L 16 18 C 16 18.5 16.5 19 17 19 L 18.5 19 C 19.5 19 20 18.5 20 17.5 L 20 16 L 21 15.5 C 22 15 22.5 14 22.5 13 L 22.5 9" strokeLinejoin="round"/>
                
                {/* 좌측 헤드라이트 (채워진 원) */}
                <circle cx="6.5" cy="11.5" r="2" fill="currentColor" stroke="currentColor" strokeWidth="2.5"/>
                
                {/* 우측 헤드라이트 (채워진 원) */}
                <circle cx="17.5" cy="11.5" r="2" fill="currentColor" stroke="currentColor" strokeWidth="2.5"/>
                
                {/* 상단 그릴 라인 */}
                <line x1="10" y1="10.5" x2="14" y2="10.5" strokeWidth="2" strokeLinecap="round"/>
