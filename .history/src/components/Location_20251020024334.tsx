        ...
        <div className="transportation-info-new">
          <div className="transport-item">
            ...
            <div className="transport-details">
              <p className="transport-detail-text">도보 5분 소요 - 2시간 무료 주차<br>asd</br></p>
              <p className="transport-detail-text"><strong>제1 주차장:</strong> 서울시 강남구 논현동 237-12 경복주차장</p>
              <p className="transport-detail-text"><strong>제2 주차장:</strong> 서울시 강남구 언주로 603 국민은행</p>
              <p className="transport-detail-text"><strong>제3 주차장:</strong> 서울시 강남구 언주로 609 PAX타워</p>
            </div>
          </div>
