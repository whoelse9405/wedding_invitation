        ...
        <div className="transportation-info-new">
          <div className="transport-item">
            <div className="transport-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                {/* 상단 지붕 */}
                <path d="M 5 8 L 7 4 C 7.5 3 8.5 2.5 10 2.5 L 14 2.5 C 15.5 2.5 16.5 3 17 4 L 19 8" strokeLinecap="round" strokeLinejoin="round"/>
                
                {/* 자동차 본체 */}
                <path d="M 2 8 L 2 14 C 2 15 2.5 15.5 3.5 16 L 5 16 L 5 17.5 C 5 18 5.5 18.5 6 18.5 L 7 18.5 M 17 18.5 L 18 18.5 C 18.5 18.5 19 18 19 17.5 L 19 16 L 20.5 16 C 21.5 15.5 22 15 22 14 L 22 8 L 2 8" strokeLinecap="round" strokeLinejoin="round"/>
                ...
                {/* 그릴 */}
                <line x1="10" y1="11" x2="14" y2="11" strokeWidth="2" strokeLinecap="round"/>
              </svg>
