...
현재는 반투명 배경으로 설정되어 있어 뒤에 메인 사진이 보입니다:

```css
.splash-screen {
  background: linear-gradient(
    135deg, 
    rgba(232, 245, 233, 0.95) 0%,   /* 95% 불투명 */
    rgba(255, 255, 255, 0.92) 50%,  /* 92% 불투명 */
...
rgba(232, 245, 233, 0.85)  /* 0.95 → 0.85 */

/* 더 불투명하게 (메인 사진이 덜 보임) */
rgba(232, 245, 233, 0.98)  /* 0.95 → 0.98 */
```

**블러 효과 조절:**
```css
backdrop-filter: blur(4px);   /* 약한 블러 */
backdrop-filter: blur(12px);  /* 강한 블러 */
