    ...
    <section ref={elementRef} className={`datetime-section ${isVisible ? 'animate' : ''}`}>
      ...
      <div className="datetime-content">
        ...
        <div className="date-info">
          <p className="date-main">2026년 1월 25일 토요일 | 오후 2시 30분</p>
          <p className="date-detail">Saturday, January 25, 2026 | PM 2:30</p>
        </div>
        ...
        <div className="datetime-footer">
          <p>동진 ❤️ 예인 결혼식이 <strong>{timeLeft.days}일</strong> 남았습니다</p>
        </div>
      </div>
    </section>
  );
